...
**None.** There were two, and both are decided:
...
The section stays rather than being deleted, and so do the two entries: a reader
who remembers the question should find the answer where the question was. What
remains before `v1.0.0` is the API review of section 7, which is a review and
not an open question — it has to *look at* a surface that is already decided.
